package com.appaspect.btcrate.data.prefs;
...
public class SharedPreferenceUtils {
    ...
    private String MyPreferences="BTC_CNV_Preferences";

    public static String KEY_User_Name="Is_RATING";
    public static String KEY_Selected_Currency="Selected_Currency";
